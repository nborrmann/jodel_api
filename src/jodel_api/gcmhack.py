...
import varint
import json
from .protos import checkin_pb2
from .protos import mcs_pb2

class AndroidAccount:

    def __init__(self):
        try:
            self._google_checkin()
        except:
            raise

    def _google_checkin(self):
    ...
    def get_push_token(self):
        ...
        r = requests.post("https://android.clients.google.com/c2dm/register3", headers=headers, data=data)
